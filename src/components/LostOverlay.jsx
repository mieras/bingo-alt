...
const LostOverlay = ({ onClose, onBackToOverview }) => {
  ...
  return (
    <div className="absolute top-[1vh] left-0 right-0 bottom-0 z-40 flex  justify-center items-end bg-black/30 backdrop-blur-md">
